...
class QuestionsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userNameHere1 = intent.getStringExtra(Constants.USER_NAME)
    ...
    fun displayQuestions() {
        ...
        if (counter == 10) {
            ...
            intent.putExtra(Constants.USER_NAME, userNameHere1)
            intent.putExtra(Constants.CORRECT_ANSWERS, answerCounter)
            intent.putExtra(Constants.TOTAL_QUESTIONS, counter)
            intent.putExtra(Constants.CATEGORY, choice1)
...
//class MoneyClass (var questions: String, var choices : List<String>, var rightAnswer: Int)
